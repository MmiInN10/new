...
public final class CustomToastBinding implements ViewBinding {
  ...
  private CustomToastBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout toastContainer,
  ...
  public static CustomToastBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      LinearLayout toastContainer = (LinearLayout) rootView;
      ...
      return new CustomToastBinding((LinearLayout) rootView, toastContainer, toastText);
    }
